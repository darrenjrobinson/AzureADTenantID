@{
    ...
    Description          = 'Lookup Azure Active Directory OIDC AuthZ Endpoint using Domain Name and return the TenantID. Lookup an Azure Tenant based on Domain Name and return any other associated Domain Names. '
    PowerShellVersion    = '5.1'
    CompatiblePSEditions = 'Core', 'Desktop'
    RequiredModules      = ''
    FunctionsToExport    = @('Get-AzureADTenantId', 'Get-AzureADCustomDomains')
    CmdletsToExport      = @()
    VariablesToExport    = @()
    AliasesToExport      = @('Get-EntraIDTenantId', 'Get-EntraIDCustomDomains')
    PrivateData          = @{
        PSData = @{
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDr2amQPZedlifG
# NgI9Itw/u5pfcmRXVaO5SeMj/bcStaCCISwwggWNMIIEdaADAgECAhAOmxiO+dAt
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCDWZd7wiD6sAy+0
# Dh93SlSRjhkSX3xWnb1NDv7oL8Q7PDANBgkqhkiG9w0BAQEFAASCAgCU/650Cw13
# HcY9v9ZLvXLue5nATxLugccQpFkTJk3ct0JIQO7lcx2FDQAd+ygpWa4gkfInvW32
# VHPyOHrFYxcLRv6VgeA7dquKeX8eor5JGix5DbAP7qwG8ZZ/Z5fxEXUCQXeKmyfU
# qCglWcwNIxS3fpF74oU0AigN33vTtmedLrAdHp+5V9TaxB3b9ec7WcOJWn40he+0
# gIFVy14m/d+mfiO1NtWbsmE5MJHvtHZ10Nh3aU0bmHexReXmGAPfKSeFljZKCXsv
# tRHxVWX7ORIMdsyCBleg/EDvJkRqGQXPzBzsbNgUGo/TytOQ98h10SLS4vNP6LwP
# IdoOUkGbyLw4qKi2vetP5pEMEZbqCwEHfZQOTwL5It9aH0u2IBsEML+MhOmph8Qs
# BrzMf1Ibh3CtxNYlokWGNEwklquZP6kc8i54gIJG3dYqlSNl07JyB0VwgmfOQvb3
# sL8q2vSem4nuudoepMOH0nEiG/Bh2aKfEpNjxiGkLhETcaVH+pB/g25SBQtVrKuP
# wXjLHpzamtPVc++iRD/9v0rS+TZ57F03fuS1R11H8L5EcjvXsNR3ejW32Eh5s0ru
# PheH1uws3DwkJYJVAw3+Yz+DLD/wr2puy/w+jkpMpKmDktKNrt+ScxP56Q5GEdbs
# 0owkMyw1XCCIaWiL8gNM/y7vI6mT3OI/K6GCAyAwggMcBgkqhkiG9w0BCQYxggMN
...
# MjEwMDA3MTdaMC8GCSqGSIb3DQEJBDEiBCBIRHrcDXuZm4Jmu6HN0Ahqb9w/T+pz
# OUm0fUphx0iSvjANBgkqhkiG9w0BAQEFAASCAgBJHMF3JAVSmeroDn+f57QgPFKN
# MQbjlqLXWxH5+8z7RBwWgrE+zM4xn2cGTm0MaVErL2jVJWurbX6LZN4OJcbe4Kfu
# JZjiIdAfOEs8o9CdbHRU8KjlkwJBH429Yb+77ezojwvU8U7VLyls/QUFxjT11ffL
# mqgpt6cagewfJZkTzgQIfvr4QBhczTkjX+Lm22BvmakxpldSoP/SfnjYKat46dKs
# ncufyqmSHS0vHK58YGZwW17PSjrolFh8sKBEfj78wzQu/3ujND4Q3FXLTpngUpXU
# Xj9SFfxx2ofW5M0IA6lsP1Y/PGx9M5PbXqIi0ysNjQW4ckI7+IaxZ6q1jD1hY3V7
# 5x5Txx8Kn1ginXjix4tnTlMUcxBBQtCwEE0Z37DP58IG8gmnwUx/03rOHmOK2Pnf
# fF6JnlU/Zed3smzT02qIcWL4uwfD8BwWDj/GAyfNGGf2p5UaQiXCJl5iCFhHGZpO
# U+4HdUhXa6kQFC1OjJ5HxTp8KOB2ZXNCKO76Rjk9g/c1NzWKcbdfyNvuc+wxeiVV
# hjU7ADGbewEtHlQ/c4Bv/B5pFz3rZol0YEQBkxBhZ0dBYeFswoxJVjbXBr22tppj
# sIu1gXfx72RJHsjzT5OBGF48Citwl8dhZisyRCr4sgSRnw9endC9NvltV9hRqhWZ
# /46D1CysUTF4Z5a3Sg==
